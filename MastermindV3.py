...
def play_game(button_color):
    ...
    for label in row_list:
        if label.cget("background") == "gray70":
            label.config(background = button_color, relief = "flat")
            break
    ...
    if chances == 0:
        messagebox.showinfo("Oh no!", "Game over! Better luck next time")
        reveal_color()
        reset_game()
...
def clear_game_board():
    row_list = game_list[chances - 1]
    for label in row_list:
        label.config(background = "gray70", relief = "flat")
...
def reset_game():
    ...
    for label in row1_ans_list:
        label.config(background = "white", text = "?", relief = "flat")
...
# Output = None
def draw_game_board():    
    title_label = Label(window, bg = "#252029", text = "M A S T E R M I N D", fg = "white", font = ("Trebuchet MS", 15))
    title_label.grid(row = 0, column = 1, columnspan = 8, pady = 5)
    #---------------------------------------------------START ROW 1---------------------------------------------------------------
    row1_label0 = Label(window, background = "white", text = "#", width = 3)
    row1_label0.grid(row = 1, column = 1, padx = 5, pady = 10)

    row1_ans_color1 = Label(window, background = "white", width = 3, height = 1, text = "?")
    row1_ans_color1.grid(row = 1, column = 2, padx = 5, pady = 10)
    row1_ans_list.append(row1_ans_color1)

    row1_ans_color2 = Label(window, background = "white", width = 3, height = 1, text = "?")
    row1_ans_color2.grid(row = 1, column = 3, padx = 5, pady = 10)
    row1_ans_list.append(row1_ans_color2)

    row1_ans_color3 = Label(window, background = "white", width = 3, height = 1, text = "?")
    row1_ans_color3.grid(row = 1, column = 4, padx = 5, pady = 10)
    row1_ans_list.append(row1_ans_color3)

    row1_ans_color4 = Label(window, background = "white", width = 3, height = 1, text = "?")
    row1_ans_color4.grid(row = 1, column = 5, padx = 5, pady = 10)
    row1_ans_list.append(row1_ans_color4)

    row1_ans_color5 = Label(window, background = "white", width = 3, height = 1, text = "?")
    row1_ans_color5.grid(row = 1, column = 6, padx = 5, pady = 10)
    row1_ans_list.append(row1_ans_color5)

    row1_blackcount = Label(window, background = "white", width = 3, height = 1, text = "B")
    row1_blackcount.grid(row = 1, column = 7, padx = 5, pady = 10)

    row1_whitecount = Label(window, background = "white", width = 3, height = 1, text = "W")
    ...
    for i in range(0, chances):
        row_num = i + 2
        colors_list = []
        Label(window, background = "white", width = 3, text = chances - i).grid(row = row_num, column = 1, padx = 5, pady = 2)
        for j in range(0, 5):
            col_num = j + 2
            colors_list.append(Label(window, background = "gray70", width = 3, height = 1))
            colors_list[j].grid(row = row_num, column = col_num, padx = 5, pady = 2)
        game_list.append(colors_list)

        b_list.append(Label(window, background = "black", fg = "white", width = 3, height = 1))
        b_list[i].grid(row = row_num, column = 7, padx = 5, pady = 2)

        w_list.append(Label(window, background = "white", width = 3, height = 1))
    ...
    blue_button = Button(window, width = 3, height = 1, bg = "blue", text = "1", command = lambda : play_game("blue"), relief = "flat")
    blue_button.grid(row = 15, column = 1, pady = 10)
    	
    blue_button.master.bind('1', lambda event: play_game("blue"))

    red_button = Button(window, width = 3, height = 1, bg = "red", text = "2", command = lambda : play_game("red"), relief = "flat")
    red_button.grid(row = 15, column = 2)
    red_button.master.bind('2', lambda event: play_game("red"))


    green_button = Button(window, width = 3, height = 1, bg = "green3", text = "3", command = lambda : play_game("green3"), relief = "flat")
    green_button.grid(row = 15, column = 3)
    green_button.master.bind('3', lambda event: play_game("green3"))


    yellow_button = Button(window, width = 3, height = 1, bg = "yellow", text = "4", command = lambda : play_game("yellow"), relief = "flat")
    yellow_button.grid(row = 15, column = 4)
    yellow_button.master.bind('4', lambda event: play_game("yellow"))

    sb_button = Button(window, width = 3, height = 1, bg = "saddle brown", text = "5", command = lambda : play_game("saddle brown"), relief = "flat")
    sb_button.grid(row = 15, column = 5)
    sb_button.master.bind('5', lambda event: play_game("saddle brown"))

    turq2_button = Button(window, width = 3, height = 1, bg = "turquoise2", text = "6", command = lambda : play_game("turquoise2"), relief = "flat")
    turq2_button.grid(row = 15, column = 6)
    turq2_button.master.bind('6', lambda event: play_game("turquoise2"))

    hp_button = Button(window, width = 3, height = 1, bg = "hot pink", text = "7", command = lambda : play_game("hot pink"), relief = "flat")
    hp_button.grid(row = 15, column = 7)
    hp_button.master.bind('7', lambda event: play_game("hot pink"))

    dv_button = Button(window, width = 3, height = 1, bg = "dark violet", text = "8", command = lambda : play_game("dark violet"), relief = "flat")
    dv_button.grid(row = 15, column = 8)
    dv_button.master.bind('8', lambda event: play_game("dark violet"))
    #-------------------------------------------Row 16-----------------------------------------------
    #empty_label16 = Label(window, width = 2, background = "light blue").grid(row = 16, column = 0, padx = 15, pady = 20)

    rules_button = Button(window, width = 6, height = 1, text = "rules", bg = "white", command = rules, font = ("consolas", 10))
    rules_button.grid(row = 16, column = 1, columnspan = 3)
    
    reset_button = Button(window, width = 8, height = 1, text = "new game", bg = "white", command = reset_game, font = ("consolas", 10))
    reset_button.grid(row = 16, column = 4, columnspan = 2, pady = 5)

    clear_button = Button(window, width = 6, height = 1, text = "clear", bg = "white", command = clear_game_board, font = ("consolas", 10))
    clear_button.grid(row = 16, column = 6, columnspan = 3, pady = 5)

    #-------------------------------------------Row 17------------------------------------------------
    reveal_ans_button = Button(window, width = 7, height = 1, text = "cheat", bg = "white", command = reveal_color, font = ("consolas", 10))
...
#bg_image = ImageTk.PhotoImage(Image.open("C:\\Users\\Pranav\\Desktop\\APCteate\\wood.jpg"))
background_label = Label(window, bg = "#252029")
